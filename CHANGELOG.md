...
## [1.0.22] — Git 記録日: 2026-09-12

- ポップアップを落ち着いた配色とシンプルな面構成へ変更
- スクロールスナップなどで計画位置からずれた撮影を中止し、不完全な連結画像の保存を防止
- Chrome と Firefox の両方でショートカット設定画面を正しく開けるよう改善
- ブラウザ固有だった案内文を Chrome / Firefox 共通の表現へ変更

出典: [版の記録](https://github.com/1llum1n4t1s/EvidenceShot/commit/f091769b9a00f7506fce6655e43998cb2d789575) / [変更差分](https://github.com/1llum1n4t1s/EvidenceShot/compare/16522336bbdc8501ad905cecb62d2c7fb3b86c44...f091769b9a00f7506fce6655e43998cb2d789575)。
